...
function (a) {
    ...
    a.laydate = function (b) {
        ...
        c.elem[h.elemv] = f, b || (!c.options.istime ? c.close() : null,console.log(e), "function" == typeof c.options.choose && c.options.choose(f))
    }, c.events = function () {
        var b = c.query,
			e = {
			    box: "#" + h[0]
        ...
        c.addClass(d.body, "laydate_body"), h.tds = b("#laydate_table td"), h.mms = b("#laydate_ms span"), h.year = b("#laydate_y"), h.month = b("#laydate_m"), c.each(b(e.box + " .laydate_ym"), function (a, b) {
            ...
            c.on(b, "click", function (a) {
                ...
                c.hasClass(this, h[1]) || (c.ymd[0] = this.getAttribute("y"), c.ymd[1] = this.getAttribute("m") - 1, c.ymd[2] = this.getAttribute("d"), c.each(h.tds, function (a, b) {
                    c.removeClass(b, h[2]),
                    c.addClass(that, h[2])
                }),c.stopmp(a), !c.options.istime ? c.creation([0 | this.getAttribute("y"), 0 | this.getAttribute("m"), 0 | this.getAttribute("d")]) : null);
            })
